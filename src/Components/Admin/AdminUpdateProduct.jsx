...
export default function AdminUpdateProduct() {
    ...
    var product = useSelector((state) => state.ProductStateData) //product hai state get data
    ...
    useEffect(() => {
        ...
        dispatch(getBrand()) 
        dispatch(getProduct())
        var item = product.find((item)=>item.id===Number(id)) //product aaega get data me use set data me assign kr dena hai
        if(item)
