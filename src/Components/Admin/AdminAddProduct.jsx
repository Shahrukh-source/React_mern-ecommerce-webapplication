...
export default function AdminAddProduct() {
    ...
    var maincategory = useSelector((state) => state.MaincategoryStateData) //use for get data from maincategory.. then set dispatch
    ...
    function getFile(e) {
        var name = e.target.name
        var value = e.target.files[0].name //file krdo to only imag hi mil jaegi
        setdata((old) => {
            return {
                ...old,
                [name]: value
    ...
    function postData(e) {
        ...
        var br = data.brand
        if(mc==="") //agar mc blank hai to index 0
        mc=maincategory[0].name
        if(sc==="")
        sc=subcategory[0].name // agar sc blank hai to index 0
        if(br==="")
        br=brand[0].name //agar brand blank hai to index 0
        var item = {
            name:data.name,
            maincategory:mc,
            subcategory:sc,
