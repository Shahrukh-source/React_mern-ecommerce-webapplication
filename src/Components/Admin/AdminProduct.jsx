...
export default function AdminProduct() {
    ...
    var columns = [
        ...
        { field: 'name', headerName: 'Name', width: 200 },//name badha ho jaega
        ...
        { field: 'baseprice', headerName: 'Base Price', width: 100, renderCell: ({ row }) => <p>&#8377;{row.baseprice}</p>}, //yha base price ko rupess me showkrne k liye&#83 use kiya hai
