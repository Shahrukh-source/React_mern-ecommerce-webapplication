							...
							<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img src={`/assets/productimages/${p.pic1}`} height="600px" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item">
										<img src={`/assets/productimages/${p.pic2}`} height="600px" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item active">
										<img src={`/assets/productimages/${p.pic3}`} height="600px" class="d-block w-100" alt="..." />
									</div>
									<div class="carousel-item">
										<img src={`/assets/productimages/${p.pic4}`} height="600px" class="d-block w-100" alt="..." />
									</div>
